...
describe("ed25519", () => {
  ...
  it("should create right publicKey without SHA-512 hashing TEST 1", () => {
    ...
    const publicKey = ed25519.scalarmultBase(4090177687267471719164802180371655790974410769055056530206928641275872410231n);
  ...
  it("should create right publicKey without SHA-512 hashing TEST 2", () => {
    ...
    const publicKey = ed25519.scalarmultBase(95951719164491934016098152084711983042317968705124759109304017803304340360n);
  ...
  it("should create right publicKey without SHA-512 hashing TEST 3", () => {
    ...
    const publicKey = ed25519.scalarmultBase(5251021594357742159570582158299009909606168663234119833766344637273690532161n);
  ...
  it("should create right publicKey without SHA-512 hashing TEST 4", () => {
    ...
    const publicKey = ed25519.scalarmultBase(2992220612772705148923293930750391889471356540185692956764167374764935455854n);
